hackyNews.factory('LinksFactory', function LinksFactory() {
  var factory = {};
  factory.links = [
{ title: 'Test1', url: 'http://www.google.com', user: 'amy123', id: 1, points: 7, comments: [], rank: 0, date: new Date()},
    { title: 'Test2', url: 'http://www.bing.com', user: 'clem321', id: 2, points: 3, comments: [], rank: 0, date: new Date(2015,01,26,10)},
  { title: 'Test3', url: 'http://www.bing.com', user: 'clem321', id: 3, points: 10, comments: [], rank: 0, date: new Date(2015,01,20)}
  ];
